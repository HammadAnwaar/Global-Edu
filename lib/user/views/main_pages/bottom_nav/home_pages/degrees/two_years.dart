...
class TwoYearsDegree extends StatefulWidget {
  const TwoYearsDegree({super.key});

  @override
  State<TwoYearsDegree> createState() => _TwoYearsDegreeState();
}

class _TwoYearsDegreeState extends State<TwoYearsDegree> {
  ...
  Future<List<Map<String, dynamic>>> _fetchUniversities() async {
    try {
      QuerySnapshot querySnapshot = await _firestore
          .collection('degrees')
          .where('duration', isEqualTo: '2 years')
          .get();
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => DegreeDocPage(
                          docId: docId, degreeLink: data['degreeLink']),
                    ),
                  );
                },
