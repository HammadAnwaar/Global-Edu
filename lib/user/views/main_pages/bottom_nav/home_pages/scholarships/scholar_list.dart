...
import 'package:global_edu/user/views/main_pages/bottom_nav/home_pages/scholarships/scholar_doc.dart';
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ScholarDocPage(
                            docId: docId,
                            scholarLink: data['scholarshipLink'],
                          ),
                        ),
                      );
                    },
